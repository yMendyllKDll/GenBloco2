...
-- -----------------------------------------------------
-- Table `db_loja_games`.`td_categorias`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db_loja_games`.`td_categorias` (
...
CREATE TABLE IF NOT EXISTS `db_loja_games`.`tb_produtos` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_tb_produtos_td_categorias_idx` (`categoria_id` ASC) VISIBLE,
  INDEX `fk_tb_produtos_tb_usuarios1_idx` (`usuario_id` ASC) VISIBLE,
  CONSTRAINT `fk_tb_produtos_td_categorias`
    FOREIGN KEY (`categoria_id`)
    REFERENCES `db_loja_games`.`td_categorias` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
